...
export default function WatchVideoButton() {
  return (
    <button >
      ...
      <div className="flex items-center justify-center px-3 py-2 text-2xl text-white transition duration-200 border-2 border-white shadow-2xl aline rounded-4 font-poppins font-[700] hover:bg-cBlue">
